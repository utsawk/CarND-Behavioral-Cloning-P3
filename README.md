...
3. Brighness augmentation: The brightness is scaled uniformly at random from [0.5, 1.5] (code inspired by [3]). The track 2 for the project is a little darker and changing brightness would help the neural network to learn better. 
